...
<div class="mb-3">
    ...
    <input class="form_control" type="text" name="full_name" placeholder="FULL NAME" required />
</div>
<div class="mb-3">
    <label for="phone">PHONE </label>
    <input class="form_control" type="number" name="phone" placeholder="PHONE" required />
</div>
<div class="mb-3">
    <label for="email">EMAIL </label>
    <input class="form_control" type="text" name="email" placeholder="EMAIL" required />
</div>
<div class="mb-3">
